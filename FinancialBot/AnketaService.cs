...
namespace FinancialBot
{
    public class AnketaService
    {
        ...
        {
            "📋 Вопрос 2: Какой у вас доход в месяц?",
            "📋 Вопрос 3: Есть ли у вас финансовая подушка безопасности?",
            "📋 Вопрос 4: Какую часть дохода вы готовы инвестировать?",
            "📋 Вопрос 5: На какой срок планируете инвестировать? (Краткосрочно, Среднесрочно, Долгосрочно)",
            "📋 Вопрос 6: Как вы относитесь к риску? (Негативно, Нейтрально, Положительно)",
            "📋 Вопрос 7: Какой у вас инвестиционный опыт? (Нет, Базовый, Продвинутый)",
            "📋 Вопрос 8: Как часто вы готовы пересматривать инвестиционный портфель? (Редко, Раз в год, Часто)"
        };
        ...
        public InvestmentRecommendation Analyze(List<string> answers)
        {
            ...
            //recommendation.Other = aiService.GetGeminiResponse().GetAwaiter().GetResult();
